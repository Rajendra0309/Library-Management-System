  ...
  return (
    <aside className="hidden md:flex flex-col h-full border-r border-border-subtle bg-bg-sidebar shadow-sm fixed left-0 top-0 w-[256px] transition-all duration-300 z-50">
      ...
      <div className="p-lg border-t border-border-subtle mt-auto space-y-xs">
        <a className="flex items-center gap-md px-md py-sm text-text-secondary hover:bg-bg-hover hover:text-primary transition-colors rounded-lg font-body-base text-body-base" href="#">
          <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 0" }}>help</span>
          Help Center
        </a>
        <a className="flex items-center gap-md px-md py-sm text-error hover:bg-error-container transition-colors rounded-lg font-body-base text-body-base" href="#">
